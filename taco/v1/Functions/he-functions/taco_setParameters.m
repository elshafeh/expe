...
if strcmp(Info.debug,'no')
    ...
    rectDisplay             = [70 70 200 200]; % small % [100 100 1300 700]; % big % 
end
...
stim.Fix.PossibColor        = scr.gray/2; % {scr.black,scr.white};
...
stim.dur.cue                = round(0.3 ./ scr.ifi) * scr.ifi;
