function [tStim1,tStim2] = taco_drawstim(target)
...
if IsLinux
    scr.b.sendTrigger(stim.code); % send stim trigger
end

% --------- ISI  ------------
taco_darkenBackground;
JY_VisExptTools('draw_fixation', stim.Fix); % draw fixation
tStim2                  = Screen('Flip', wPtr, tStim1+stim.dur.target - scr.ifi/2); % flip to the screen
