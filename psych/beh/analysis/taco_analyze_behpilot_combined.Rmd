...
data_table          <- read.table("/Users/heshamelshafei/Documents/GitHub/taco/psych/beh/analysis/taco_behavpilot_combined.txt", sep = ',',header=T)
data_table$bloc     <- factor(data_table$bloc , levels = c("fixed","jittered")) # re-order factor names
