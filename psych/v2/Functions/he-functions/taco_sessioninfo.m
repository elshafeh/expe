...
switch isnew
    ...
    case 'n'
        ...
        nb_train                = length(dir(['Logfiles/' Info.name '/' Info.name '_taco_v2_train_*_Logfile.mat']));
        tmp                     = load(['Logfiles/' Info.name '/' Info.name '_taco_v2_train_' num2str(nb_train) '_Logfile.mat']);
